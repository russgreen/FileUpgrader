...
partial class Build
{
    ...
    .Executes(() =>
    {
        var aipProjectPath = Path.Combine(RootDirectory, @"installer\FileUpdgrader.aip");
        var version = Solution.FileUpgrader.GetProperty("Version");
    ...
    {
        var aipOutputPath = Path.Combine(RootDirectory, @"installer\FileUpdgrader-SetupFiles");
